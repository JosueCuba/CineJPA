...
import modelo.dao.FuncionFacade;
...
public class FuncionController implements Serializable {
    ...
    @EJB
    private modelo.dao.FuncionFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Vista").getString("FuncionCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Vista").getString("FuncionUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Vista").getString("FuncionDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    @FacesConverter(forClass = Funcion.class,value = "funcionConverter")
    public static class FuncionControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Funcion) {
                ...
                return getStringKey(o.getIdfunc());
            } else {
